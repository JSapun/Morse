...
HD_PWD='O:/ENGS31/MorseCode_VGA/MorseCode_VGA.runs/bitmaps_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitmaps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitmaps.tcl
