...
HD_PWD='O:/ENGS31/MorseCode_VGA/MorseCode_VGA.runs/ascii_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascii_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascii_memory.tcl
