...
HD_PWD='O:/ENGS31/MorseCode_VGA/MorseCode_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_logic_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_logic_shell.tcl -notrace
