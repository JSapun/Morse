...
HD_PWD='O:/ENGS31/MorseCode_VGA/MorseCode_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_logic_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_logic_shell.tcl
